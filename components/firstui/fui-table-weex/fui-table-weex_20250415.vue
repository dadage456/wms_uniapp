...
<!-- 									<view class="fui-table__checkmark" :style="{ borderBottomColor: checkmarkColor, borderRightColor: checkmarkColor }"></view>
 -->									
									<view class="fui-table__checkmark" :style="{ borderBottomColor: highlight && isHighlight(index) ? '#238E23': checkmarkColor, borderRightColor: highlight && isHighlight(index) ? '#238E23' : checkmarkColor }"></view>
