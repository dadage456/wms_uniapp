...
class FloorExceptionCollectState {
  const FloorExceptionCollectState({
  ...
  final List<FloorExceptionCollectionItem> items;
  final List<String> selectedIds;
  final List<FloorExceptionStock> stocks;
  ...
  FloorExceptionCollectState copyWith({
    String? placeholder,
    bool? focus,
    bool? isLoading,
    ...
    List<FloorExceptionStock>? stocks,
    String? matCode,
    String? batchNo,
    String? sn,
    String? matControlFlag,
  }) {
    return FloorExceptionCollectState(
