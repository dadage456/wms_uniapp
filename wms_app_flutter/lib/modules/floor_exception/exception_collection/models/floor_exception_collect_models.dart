...
class FloorExceptionCollectionItem {
  const FloorExceptionCollectionItem({
    required this.id,
  ...
  FloorExceptionCollectionItem copyWith({
    String? id,
    String? matCode,
    String? storeSite,
    ...
    return FloorExceptionCollectionItem(
      id: id ?? this.id,
  ...
  static FloorExceptionCollectionItem create({
...
class FloorExceptionStock {
  const FloorExceptionStock({
    required this.id,
    required this.matCode,
    required this.batchNo,
    required this.sn,
...
class FloorExceptionTypeOption {
  const FloorExceptionTypeOption({required this.value, required this.label});
